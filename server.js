// server.js (phiên bản cuối cùng, đã sửa lỗi SyntaxError của ký tự $)
...
// --- TRANG TÀI LIỆU HƯỚNG DẪN (Đã sửa lỗi cú pháp cuối cùng) ---
const docsHtml = `
<!DOCTYPE html>
<html lang="vi">
<head>
