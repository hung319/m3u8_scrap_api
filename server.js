// server.js (Phiên bản cuối cùng, sạch, đã sửa lỗi copy-paste)
...
const wildcardToRegex = (pattern) => {
    // Đây là dòng code đúng, không chứa HTML
